...
const CoursesPage = () => {
    ...
    const [categories, setCategories] = useState([
        { id: 'all', name: 'All Courses', icon: <FaFilter /> }
    ]);
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const res = await apiClient.get(API_ENDPOINTS.COURSES.replace('/courses/', '/categories/'));
                const iconMap = {
                    'programming': <FaCode />,
                ...
                setCategories([{ id: 'all', name: 'All Courses', icon: <FaFilter /> }, ...mappedCats]);
            } catch (error) {
    ...
    return (
        <>
            <Helmet>
                <title>All Courses - EduShare School</title>
                <meta name="description" content="Browse our wide selection of free online courses in programming, mathematics, science, and languages. Learn from peer educators." />
            </Helmet>
            ...
            <div className="courses-page">
                ...
                <section className="courses-header">
                    <div className="container">
                        ...
                        >
                            Discover amazing courses taught by fellow students
                        </motion.p>
                    </div>
                </section>
                            ...
                            >
                                ...
                                <div className="course-content">
                                    ...
                                    <div className="course-footer">
                                        <div className="instructor">By {course.author?.full_name || course.author?.username}</div>
