        ...
        if (youtubeVideoId) {
            return (
                <YouTubePlayer
                    ...
                    initialTime={course.last_watched_time}
                />
            );
        }
                ...
                <div className="course-watch-container">
                            ...
                            <div className="watch-meta-row">
                                <div className="watch-stats">
                                    <div className="instructor-mini">
                                        ...
                                        <div>
                                            ...
                                            <span>{course.author?.school || 'O\'qituvchi'}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="watch-actions">
                                    <button className="btn-action">
                                        <FaStar className="text-yellow" /> {course.rating || 4.5}
                                    </button>
                                    <button className="btn-action">
                                        <FaShare /> Ulashish
                                    </button>
                                    <button
                                        className={`btn-action ${course.is_saved ? 'active' : ''}`}
                                        onClick={handleSave}
                                    >
                                        <FaHeart style={{ color: course.is_saved ? 'var(--primary)' : 'inherit' }} /> {course.is_saved ? 'Saqlangan' : 'Saqlash'}
                                    </button>
                    ...
                    <div className="watch-sidebar">
                        ...
                        <div className="enroll-card">
                            ...
                            >
                                {enrolling ? 'Yozilmoqda...' : course.is_enrolled ? 'Yozilingan' : 'Hozir Yoziling'}
                            </button>
                            <ul className="course-features">
                                <li><FaClock /> {course.duration || 'O\'z tezligida'}</li>
                                <li><FaTrophy /> Tugatish sertifikati</li>
                                <li><FaCheckCircle /> Umrbod kirish</li>
                            </ul>
                        </div>
