...
const ProfilePage = () => {
    ...
    return (
        <div className="profile-page container">
            <Helmet>
                <title>{user.full_name || 'Profilim'} - EduShare | Ruslan Xusenov</title>
                <meta name="description" content={`${user.full_name || 'Foydalanuvchi'} - EduShare School profili. Ruslan Xusenov tomonidan yaratilgan ta'lim platformasi.`} />
            ...
            {showCompleteProfile && (
                <div className="modal-overlay" style={{
                    ...
                    <div className="modal-content glass" style={{ padding: '2rem', maxWidth: '500px', width: '90%', borderRadius: '1rem', background: 'white' }}>
                        <h2>Profilni To'ldiring</h2>
                        <p style={{ marginBottom: '1rem', color: 'var(--gray-600)' }}>Eng yaxshi tajribaga ega bo'lish uchun qo'shimcha ma'lumotlarni kiriting.</p>
                    ...
                    >
                        <div className="glass side-card">
                            ...
                            <p className="bio-text">
                                {user.bio || "Bio hali qo'shilmagan. O'zingiz haqingizda bir oz ayting!"}
                            </p>
                            <div className="profile-detail-items" style={{ marginTop: '1rem', fontSize: '0.9rem', color: 'var(--gray-700)' }}>
                                <div style={{ marginBottom: '0.5rem' }}><strong>Maktab:</strong> {user.school || "Ko'rsatilmagan"}</div>
                                <div style={{ marginBottom: '0.5rem' }}><strong>Sinf:</strong> {user.grade || "Ko'rsatilmagan"}</div>
                                <div style={{ marginBottom: '0.5rem' }}><strong>Telefon:</strong> {user.phone_number || "Ko'rsatilmagan"}</div>
                            </div>
                    ...
                    >
                        {activeTab === 'courses' && (
                            <div className="courses-tab">
                                <h2>O'rganishni Davom Ettirish ({enrolledCourses.length})</h2>
                                {fetchingCourses ? (
                        ...
                        {activeTab === 'favorites' && (
                            <div className="favorites-tab">
                                <h2>Sevimli Darslar ({savedCourses.length})</h2>
                                {fetchingCourses ? (
                                    <div className="tab-loading">Yuklanmoqda...</div>
                        ...
                        {activeTab === 'certificates' && (
                            <div className="certificates-tab">
                                <h2>Sertifikatlarim ({certificates.length})</h2>
                                {fetchingCourses ? (
                                    <div className="tab-loading">Yuklanmoqda...</div>
